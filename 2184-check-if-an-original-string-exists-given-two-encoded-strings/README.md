<h2><a href="https://leetcode.com/problems/check-if-an-original-string-exists-given-two-encoded-strings">2184. Check if an Original String Exists Given Two Encoded Strings</a></h2><h3>Hard</h3><hr><p>An original string, consisting of lowercase English letters, can be encoded by the following steps:</p>
